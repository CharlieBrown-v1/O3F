...
register(
        id="Plan-v0",
        entry_point="gym.envs.robotics:PlanEnv",
...
for reward_type in ["sparse", "dense"]:
    ...
    # DIY
    register(
        id="Execute{}-v0".format(suffix),
        entry_point="gym.envs.robotics:ExecuteEnv",
        kwargs=kwargs,
        max_episode_steps=50,
    )
    ...
    # DIY
    register(
        id="CollectExecute{}-v0".format(suffix),
        entry_point="gym.envs.robotics:CollectExecuteEnv",
        kwargs=kwargs,
        max_episode_steps=64,
    )
    ...
    # DIY
    register(
        id="VPGCollectExecute{}-v0".format(suffix),
        entry_point="gym.envs.robotics:VPGCollectExecuteEnv",
        kwargs=kwargs,
        max_episode_steps=64,
    )
    ...
    # DIY
    register(
        id="RenderExecute{}-v0".format(suffix),
        entry_point="gym.envs.robotics:RenderExecuteEnv",
        kwargs=kwargs,
    ...
    # DIY
    register(
        id="VPGExecute{}-v0".format(suffix),
        entry_point="gym.envs.robotics:VPGExecuteEnv",
        kwargs=kwargs,
        max_episode_steps=128,
    )
    ...
    # DIY
    register(
        id="TestExecute{}-v0".format(suffix),
        entry_point="gym.envs.robotics:TestExecuteEnv",
        kwargs=kwargs,
        max_episode_steps=128,
    )
